    ...
    subCategories: [
      ...
      },
      {
        ...
        products: [
          ...
          { id: "cp5", name: "CP5 Pallet", subTitle: "760 × 1140 mm", img: "/images/products/user_cp5_pallets.webp", specs: ["Small Format Bags", "Standard CP Design", "High Unitization", "Treated Timber", "Global Acceptability"], seoTitle: "CP5 Pallet — Size, Specs & Chemical Use", h1: "CP5 Pallet — Small-Format Bag Handling", spec: { dimensions: "760 × 1140 mm", construction: "Standard CP design", timber: "Heat-treated pine / hardwood", treatment: "ISPM-15 heat treatment at 56 °C", marking: "IPPC / ISPM-15 stamp", standard: "CP series (chemical industry standard) · ISPM-15 / IPPC", applications: "Small-format bags" } },
          { id: "cp6", name: "CP6 Pallet", subTitle: "1200 × 1000 mm (Double)", img: "/images/products/user_cp6_pallets.webp", specs: ["Double Deck Design", "Maximum Rigidity", "High Stack Loading", "Chemical Grade", "Export Compliant"], seoTitle: "CP6 Pallet — Size, Specs & Chemical Use", h1: "CP6 Pallet — Double-Deck Construction", spec: { dimensions: "1200 × 1000 mm", construction: "Double-deck design", timber: "Heat-treated pine / hardwood", treatment: "ISPM-15 heat treatment at 56 °C", marking: "IPPC / ISPM-15 stamp", standard: "CP series (chemical industry standard) · ISPM-15 / IPPC", applications: "High stack loading" } },
          { id: "cp7", name: "CP7 Pallet", subTitle: "1300 × 1100 mm", img: "/images/products/user_cp7_pallets.webp", specs: ["Extra Wide Base", "Oversized Bags", "Stable Footing", "ISPM-15 Pine", "Precision Sized"], seoTitle: "CP7 Pallet — Size, Specs & Chemical Use", h1: "CP7 Pallet — Extra-Wide Base", spec: { dimensions: "1300 × 1100 mm", construction: "Extra-wide base", timber: "ISPM-15 pine", treatment: "ISPM-15 heat treatment at 56 °C", marking: "IPPC / ISPM-15 stamp", standard: "CP series (chemical industry standard) · ISPM-15 / IPPC", applications: "Oversized bags" } },
          { id: "cp8", name: "CP8 Pallet", subTitle: "1140 × 1140 mm (Drilled)", img: "/images/products/user_cp8_pallets.webp", specs: ["Drum Discharge Design", "High Strength", "Solid Perimeter", "Chemical Safe", "ISPM-15 HT"], seoTitle: "CP8 Pallet — Size, Specs & Chemical Use", h1: "CP8 Pallet — Drum Discharge Design", spec: { dimensions: "1140 × 1140 mm", construction: "Solid perimeter, drilled for drum discharge", timber: "Heat-treated pine / hardwood", treatment: "ISPM-15 heat treatment at 56 °C", marking: "IPPC / ISPM-15 stamp", standard: "CP series (chemical industry standard) · ISPM-15 / IPPC", applications: "Drum discharge" } },
    ...
    subCategories: [
      ...
      },
      {
        ...
        products: [
          ...
          { id: "jungle-wood", name: "Jungle Wood", subTitle: "Hardwood Density", img: "/images/products/2-6-inches-teak-jungle-wood-plank-anti-slip-waterproof--353.jpg", specs: ["Extreme Hardness", "Local Native Wood", "High Static Load", "Heavy Skid Base", "Naturally Durable"], seoTitle: "Jungle Wood Pallets — Density, Load & Cost", h1: "Jungle Wood Pallets — Hardwood Density", spec: { timber: "Local native hardwood", treatment: "Kiln dried", applications: "Heavy skid bases and high static-load pallets" } },
        ]
      }
    ]
  },
