...
function Services() {
  const items = [
    ...
    { name: 'Anti-Rust Coating', img: '/images/services/ai/anti_rust.png', href: '/packaging-materials/rust-preventive-spray', desc: 'VCI film treatment and anti-rust oil for long-term metal protection.' },
