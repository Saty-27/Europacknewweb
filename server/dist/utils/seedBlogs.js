...
async function seed() {
    try {
        await mongoose_1.default.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/europack');
        console.log('Connected to MongoDB');
        for (const blog of blogs) {
            await Blog_1.default.findOneAndUpdate({ slug: blog.slug }, blog, { upsert: true, new: true });
