...
const seedSuperAdmin = async () => {
    try {
        ...
        try {
            await SiteSettings_1.default.collection.dropIndexes();
        }
        catch (e) { }
        ...
        await User_1.default.deleteMany({ email: 'admin@europack.in' });
        const adminExists = await User_1.default.findOne({ email: 'Dhanik@ChairpersonEuropack' });
        if (!adminExists) {
